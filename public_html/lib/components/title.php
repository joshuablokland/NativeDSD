...
function section_title_border($title, $styled = false, $custom_classes = ['mb-48'], $link = null) {
    $html_link = '';
    $classes = array_merge(['border-bottom'], $custom_classes);
    ...
    return '
        <div class="row">
            <div class="col-12">
                <h2 class="'. implode(' ', $classes) .'">'. $title . $html_link .'</h2>
            </div>
        </div>
    ';
}
